jQuery( document ).ready( function() {
	...
	if( jQuery( 'body' ).hasClass( 'wp-customizer' ) ) {
		...
		jQuery( 'body.wp-customizer [id*="shuttle_homepage_sliderswitch"] input:radio:checked' ).closest( 'label' ).addClass( 'checked' );
		...
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage1_info"]' ).click(function(e){
			...
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage1_link"]' ).fadeToggle(300);
		...
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage2_info"]' ).click(function(e){
			...
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage2_link"]' ).fadeToggle(300);
		...
		jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage3_info"]' ).click(function(e){
			...
			jQuery( 'body.wp-customizer li[id*="shuttle_homepage_sliderimage3_link"]' ).fadeToggle(300);
